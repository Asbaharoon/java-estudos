...
public class ordenacaoMap {
  ...
  public static void main(String[] args) {
    ...
    Set<Map.Entry<Integer, Contact>> phoneOrderedContacts = new TreeSet<>(new ComparatorNumericOrder());
    ...
    Set<Map.Entry<Integer, Contact>> nameOrderedContacts = new TreeSet<>(new ComparatorNameOrder());
  ...
  static class ComparatorNumericOrder implements Comparator<Map.Entry<Integer, Contact>> {
    @Override
  ...
  static class ComparatorNameOrder implements Comparator<Map.Entry<Integer, Contact>> {
    @Override
    public int compare(Map.Entry<Integer, Contact> c1, Map.Entry<Integer, Contact> c2) {
